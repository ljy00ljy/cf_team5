...
/**
 * Servlet implementation class MyProfileOk
 */
@WebServlet("/member/myProfile_ok.do")
public class MyProfileOk extends BaseController {

	private static final long serialVersionUID = -1783549958807056775L;
...
// 이름
		...
		*/
		...
		web.redirect(web.getRootPath() + "/member/myprofile.do", 
				"회원정보가 수정되었습니다.");
