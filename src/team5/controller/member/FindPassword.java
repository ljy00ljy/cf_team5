 ...
 */
@WebServlet("/member/find_password_user_ok.do")
public class FindPassword extends  BaseController {
	private static final long serialVersionUID = 5244621717043833485L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sender = "cf@cf.com";
		String subject = "cf 비밀번호 변경 안내 입니다.";
